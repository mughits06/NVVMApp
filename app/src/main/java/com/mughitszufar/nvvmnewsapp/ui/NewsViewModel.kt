...
import com.mughitszufar.nvvmnewsapp.NewsApplication
import com.mughitszufar.nvvmnewsapp.model.Article
import com.mughitszufar.nvvmnewsapp.model.NewsResponse
...
class NewsViewModel(
    ...
    private fun hasInternetConnection(): Boolean{
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            val activityManager = connectivityManager.activeNetwork ?: return false
            val capabilities =
                connectivityManager.getNetworkCapabilities(activityManager) ?: return false
            return when {
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String){
        ...
        try {
            if (hasInternetConnection()){
                ...
                breakingNews.postValue(Resource.Error("No Interner Connection"))
            }
        }catch (t: Throwable){
            when(t){
